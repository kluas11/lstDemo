...
Page({
    ...
    getTopCategory: function (parent) {
       ...
       // https://www.o2odws.com/index.php/Api/Goods/goodsCategoryList
        var that = this;
        server.getJSON("/Goods/goodsCategoryList", { store_id: getApp().globalData.store_id},function(res){
          console.log(res)
var categorys = res.data.result;
    ...
    getCategory: function (parent) {
        ...
        server.getJSON('/Goods/goodsCategoryList/parent_id/' + parent, { store_id: getApp().globalData.store_id },function(res){
var categorys = res.data.result;
                that.setData({
