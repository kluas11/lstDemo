...
wx.navigateTo({
			url: '../../order/details/index?order_id='+goods['order_id']
		});
	},
...
wx.navigateTo({
			url: 'addevaluate/index?goods_name='+goods['goods_name'] + "&image=" + goods['image'] + "&spec=" + goods['spec_key_name'] + "&goods_id=" + goods['goods_id'] + "&order_id=" + goods['order_id']
		});
	},
	onLoad: function () {
